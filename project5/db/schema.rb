...
ActiveRecord::Schema.define(version: 2021_04_07_214225) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.integer "requirement_id_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "requirement_id"
    t.index ["requirement_id"], name: "index_categories_on_requirement_id"
    t.index ["requirement_id_id"], name: "index_categories_on_requirement_id_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["major_id_id"], name: "index_users_on_major_id_id"
