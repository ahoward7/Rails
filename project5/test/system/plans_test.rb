...
class PlansTest < ApplicationSystemTestCase
  ...
  test "creating a Plan" do
    ...
    fill_in "Catalog", with: @plan.catalog
    fill_in "Curr term", with: @plan.curr_term
    fill_in "Curr year", with: @plan.curr_year
    fill_in "Major", with: @plan.major
    fill_in "Name", with: @plan.name
    fill_in "Studentid", with: @plan.studentID
